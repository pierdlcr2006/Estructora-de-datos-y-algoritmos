...
def level_order_traversal(root):
    """Realiza el recorrido por niveles de un árbol binario sin usar deque."""
...
def test_level_order_traversal():
    ...
    # Caso de prueba 2: Árbol solo con hijos izquierdos
    # Estructura:
    #    1
    #   /
    #  2
    ...
    # Caso de prueba 3: Árbol solo con hijos derechos
    # Estructura:
    #1
    # \
    #  2
